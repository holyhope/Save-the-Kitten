...
public class LauncherTest {
	...
	public void testLauncherPositionNull() {
		Launcher.create(new World(new Vec2(0, 0)), null, new Vec2(4, 0));
	}

	@Test(expected = NullPointerException.class)
	public void testLauncherWorldNull() {
		Launcher.create(null, new Vec2(50, 25), new Vec2(4, 0));
	}

	@Test
	public void testLauncher() {
		World world = new World(new Vec2(0, 0));
		Launcher.create(world, new Vec2(50, 25), new Vec2(4, 0));
	...
	public void testLaunch() {
		...
		launcher = Launcher.create(world, new Vec2(5, 7), new Vec2(0, 1));
		try {
			launcher.addBullet(Cat.class);
		} catch (IllegalAccessException | IllegalArgumentException
				| InvocationTargetException | NoSuchMethodException
